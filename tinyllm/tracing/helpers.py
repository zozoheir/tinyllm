...
def end_observation(obs, function_input, function_output, output_mapping, observation_type, function_kwargs):
...
def get_current_obs(parent_observation=None, observation_type=None, name=None, function_input=None):
